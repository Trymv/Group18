...
public class Register {
    ...
    /**
     * This method takes in the name of the series you want a literature to be removed from.
     * If the series is found in the register and is instance of bookSeries,
     * the literature you want to be removed will be removed from the bookSeries.
